...
public class ThatchCarpetBlock extends CarpetBlock implements DryingBlockState {

    private final EDryingBlockState dryingState = EDryingBlockState.WET;

    public ThatchCarpetBlock() {
        super(BlockBehaviour.Properties.of(Material.GRASS,
                MaterialColor.COLOR_GREEN).strength(0.1F).sound(SoundType.GRASS));
    }
