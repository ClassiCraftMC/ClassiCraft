...
public class RealTorchBlock extends AbstractLightBlock {
    ...
    protected static final VoxelShape AABB = Block.createCuboidShape(6.0D, 0.0D, 6.0D, 10.0D, 10.0D, 10.0D);
    protected static final IntProperty TORCH_BURN_TIME = ModBlockProperties.TORCH_BURN_TIME;
    ...
    public RealTorchBlock() {
        ...
        this.setDefaultState(getDefaultState().with(LIT, false).with(TORCH_BURN_TIME, 0));
    }
    ...
    public void scheduledTick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
        LightUtils.tickTorch(state, world, pos, random, this, TORCH_BURN_TIME);
    }

    @Override
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        return LightUtils.interactTorch(world, pos, player, hand, this, Items.FLINT_AND_STEEL, TORCH_BURN_TIME, TORCH_INITIAL_BURN_TIME);
    }

    @Override
    protected void appendProperties(StateManager.Builder<Block, BlockState> builder) {
        builder.add(LIT, TORCH_BURN_TIME);
    }
