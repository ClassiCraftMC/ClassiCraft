...
public class StainedGlassStairBlock extends StairBlock implements BeaconBeamBlock {

    private final DyeColor color;

    public StainedGlassStairBlock(DyeColor pDyeColor, java.util.function.Supplier<BlockState> state) {
