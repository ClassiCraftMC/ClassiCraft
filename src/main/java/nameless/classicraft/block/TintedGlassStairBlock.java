...
public class TintedGlassStairBlock extends StairBlock {

    public TintedGlassStairBlock(Supplier<BlockState> state) {
        super(state, BlockBehaviour.Properties.of(Material.GLASS)
                .strength(0.3F)
