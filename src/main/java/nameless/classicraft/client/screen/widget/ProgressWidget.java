package nameless.classicraft.client.screen.widget;
...
public class ProgressWidget extends TooltipWidget {
    ...
    int texY;
    boolean vertical;
    Supplier<Float> maxGetter;
    Supplier<Float> currentGetter;
    ...
    public ProgressWidget(AbstractContainerScreen<?> screen,
                          ...
                          Supplier<Float> maxGetter, Supplier<Float> currentGetter) {
    ...
    public ProgressWidget(AbstractContainerScreen<?> screen,
                          ...
                          Supplier<Float> maxGetter, Supplier<Float> currentGetter) {
        this(screen, texture, x, y, texX, texY, width, height, vertical,
                Component.translatable(""), false, maxGetter, currentGetter);
    }
    ...
    public void render(PoseStack poseStack, int pMouseX, int pMouseY, float pPartialTick) {
        ...
        int x = this.x + screen.getGuiLeft();
        int y = this.y + screen.getGuiTop();
