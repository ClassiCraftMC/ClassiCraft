...
public class PlayerLastPosCapability {
    ...
    public static class Provider implements ICapabilitySerializable<Tag>, ICapabilityProvider {
        ...
        public <T> LazyOptional<T> getCapability(@Nonnull Capability<T> cap, @Nullable Direction side) {
            ...
            return ModCapabilities.PLAYER_LAST_POSITION.orEmpty(cap, handler);
        }

        @Override
        public Tag serializeNBT() {
            return PlayerLastPosCapability.writeNBT(ModCapabilities.PLAYER_LAST_POSITION, playerLastPosition, null);
        }

        @Override
        public void deserializeNBT(Tag nbt) {
            PlayerLastPosCapability.readNBT(ModCapabilities.PLAYER_LAST_POSITION, playerLastPosition, null, nbt);
        }
    }
}
