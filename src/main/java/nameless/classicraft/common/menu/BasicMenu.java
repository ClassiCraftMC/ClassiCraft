 ...
 * @author DustW
 **/
public class BasicMenu extends AbstractContainerMenu {
    protected Inventory inventory;
    protected IItemHandler invHandler;

    protected BasicMenu(MenuType<?> type, int pContainerId, Inventory inventory) {
    ...
    protected Slot addResultSlot(IItemHandler handler, int index, int x, int y) {
        return addSlot(new ItemStackHandlerResultSlot(handler, index, x, y));
    }
