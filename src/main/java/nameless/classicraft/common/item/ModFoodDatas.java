...
public class ModFoodDatas {
    ...
    public static FoodProperties SALT =
            food(0, 0.0)
                    .effect(new MobEffectInstance(TANEffects.THIRST.get(), 100, 1), 1)
                    .build();
    public static FoodProperties SALT_WATER_BOTTLE =
            food(0, 0.0)
                    .effect(new MobEffectInstance(TANEffects.THIRST.get(), 200, 2), 1)
                    .build();
