...
public class LitLanternItem extends BlockItem {
    ...
    public LitLanternItem(Properties pProperties) {
        super(ModBlocks.LANTERN.get(), pProperties);
    }
    ...
    protected BlockState getPlacementState(BlockPlaceContext pContext) {
        ...
        {
            burnTime = RealisticLanternBlock.getInitialBurnTime();
        ...
        if(state != null)
        {
            if(pContext.getLevel().isRainingAt(pContext.getClickedPos().above()))
            {
                ...
                return state.setValue(RealisticLanternBlock.getLitState(), RealisticLanternBlock.SMOLDERING).setValue(RealisticLanternBlock.BURNTIME,burnTime);
            }
            else
                return state.setValue(RealisticLanternBlock.getLitState(), RealisticLanternBlock.LIT).setValue(RealisticLanternBlock.BURNTIME,burnTime);
        }
        return null;
    }
