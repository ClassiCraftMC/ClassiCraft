...
public class LitSoulLantern extends BlockItem {
    ...
    public LitSoulLantern() {
        super(ModBlocks.SOUL_LANTERN.get() , new Item.Properties());
    }
    ...
    protected BlockState getPlacementState(BlockPlaceContext pContext) {
        ...
        if(state != null)
        {
            return state.setValue(RealisticSoulLanternBlock.LITSTATE,pStack.getOrCreateTag().getInt("lit_state")).setValue(RealisticSoulLanternBlock.BURNTIME,pContext.getItemInHand().getOrCreateTag().getInt("burnTime")).setValue(RealisticSoulLanternBlock.OIL,pContext.getItemInHand().getOrCreateTag().getInt("oil"));
        }
        return null;
    }
    @Override
