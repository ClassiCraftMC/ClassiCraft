...
public class ModStructuresProvider {

    public static final ResourceKey<Structure> NITER_ORE_VEIN = register("niter_ore_vein");

    public static void bootstrap(BootstapContext<Structure> context) {
        HolderGetter<Biome> holder = context.lookup(Registries.BIOME);
        HolderGetter<StructureTemplatePool> holder_1 = context.lookup(Registries.TEMPLATE_POOL);
    }
    ...
    private static ResourceKey<Structure> register(String name) {
        return ResourceKey.create(Registries.STRUCTURE, Helpers.identifier(name));
    }
}
