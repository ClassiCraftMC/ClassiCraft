...
public class ModLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add(ModBlocks.GRANITE_BRICKS_WALL.get(), "Granite Bricks Wall");
        add(ModBlocks.CRACKED_GRANITE_BRICKS.get(), "Cracked Granite Bricks");
        add(ModBlocks.CRACKED_GRANITE_BRICKS_SLAB.get(), "Cracked Granite Bricks Slab");
        add(ModBlocks.CRACKED_GRANITE_BRICKS_STAIRS.get(), "Cracked Granite Bricks Stairs");
        add(ModBlocks.CRACKED_GRANITE_BRICKS_WALL.get(), "Cracked Granite Bricks Wall");
        add(ModBlocks.MOSSY_GRANITE_BRICKS.get(), "Mossy Granite Bricks");
        add(ModBlocks.MOSSY_GRANITE_BRICKS_SLAB.get(), "Mossy Granite Bricks Slab");
        ...
        add(ModBlocks.DIORITE_BRICKS_WALL.get(), "Diorite Bricks Wall");
        add(ModBlocks.CRACKED_DIORITE_BRICKS.get(), "Cracked Diorite Bricks");
        add(ModBlocks.CRACKED_DIORITE_BRICKS_SLAB.get(), "Cracked Diorite Bricks Slab");
        add(ModBlocks.CRACKED_DIORITE_BRICKS_STAIRS.get(), "Cracked Diorite Bricks Stairs");
        add(ModBlocks.CRACKED_DIORITE_BRICKS_WALL.get(), "Cracked Diorite Bricks Wall");
        add(ModBlocks.MOSSY_DIORITE_BRICKS.get(), "Mossy Diorite Bricks");
        add(ModBlocks.MOSSY_DIORITE_BRICKS_SLAB.get(), "Mossy Diorite Bricks Slab");
