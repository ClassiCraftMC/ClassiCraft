...
public class ModLanguageProviderZh extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add(ModBlocks.GRANITE_BRICKS_SLAB.get(), "花岗岩台阶");
        add(ModBlocks.GRANITE_BRICKS_STAIRS.get(), "花岗岩楼梯");
        add(ModBlocks.GRANITE_BRICKS_WALL.get(), "花岗岩墙");
        add(ModBlocks.CRACKED_GRANITE_BRICKS.get(), "裂纹花岗岩砖");
        add(ModBlocks.CRACKED_GRANITE_BRICKS_SLAB.get(), "裂纹花岗岩台阶");
        add(ModBlocks.CRACKED_GRANITE_BRICKS_STAIRS.get(), "裂纹花岗岩楼梯");
        add(ModBlocks.CRACKED_GRANITE_BRICKS_WALL.get(), "裂纹花岗岩墙");
        add(ModBlocks.MOSSY_GRANITE_BRICKS.get(), "苔花岗岩砖");
        add(ModBlocks.MOSSY_GRANITE_BRICKS_SLAB.get(), "苔花岗岩台阶");
        add(ModBlocks.MOSSY_GRANITE_BRICKS_STAIRS.get(), "苔花岗岩楼梯");
        add(ModBlocks.MOSSY_GRANITE_BRICKS_WALL.get(), "苔花岗岩墙");
        add(ModBlocks.CHISELED_GRANITE_BRICKS.get(), "雕纹花岗岩砖");
        add(ModBlocks.CHISELED_GRANITE_BRICKS_SLAB.get(), "雕纹花岗岩台阶");
        add(ModBlocks.CHISELED_GRANITE_BRICKS_STAIRS.get(), "雕纹花岗岩楼梯");
        add(ModBlocks.CHISELED_GRANITE_BRICKS_WALL.get(), "雕纹花岗岩墙");
        add(ModBlocks.DIORITE_BRICKS.get(), "闪长岩砖");
        add(ModBlocks.DIORITE_BRICKS_SLAB.get(), "闪长岩台阶");
        add(ModBlocks.DIORITE_BRICKS_STAIRS.get(), "闪长岩楼梯");
        add(ModBlocks.DIORITE_BRICKS_WALL.get(), "闪长岩墙");
        add(ModBlocks.CRACKED_DIORITE_BRICKS.get(), "裂纹闪长岩砖");
        add(ModBlocks.CRACKED_DIORITE_BRICKS_SLAB.get(), "裂纹闪长岩台阶");
        add(ModBlocks.CRACKED_DIORITE_BRICKS_STAIRS.get(), "裂纹闪长岩楼梯");
        add(ModBlocks.CRACKED_DIORITE_BRICKS_WALL.get(), "裂纹闪长岩墙");
        add(ModBlocks.MOSSY_DIORITE_BRICKS.get(), "苔闪长岩砖");
        add(ModBlocks.MOSSY_DIORITE_BRICKS_SLAB.get(), "苔闪长岩台阶");
        add(ModBlocks.MOSSY_DIORITE_BRICKS_STAIRS.get(), "苔闪长岩楼梯");
        add(ModBlocks.MOSSY_DIORITE_BRICKS_WALL.get(), "苔闪长岩墙");
