...
public class FootballFishEntity extends AbstractSchoolingFish {

    public FootballFishEntity(EntityType<? extends AbstractSchoolingFish> pEntityType, Level pLevel) {
