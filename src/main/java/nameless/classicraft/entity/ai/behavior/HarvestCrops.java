package nameless.classicraft.entity.ai.behavior;
...
public class HarvestCrops extends Behavior<CustomNpc> {
    ...
    protected boolean checkExtraStartConditions(ServerLevel pLevel, CustomNpc pOwner) {
    ...
    protected void start(ServerLevel pLevel, CustomNpc pEntity, long pGameTime) {
    ...
    protected void stop(ServerLevel pLevel, CustomNpc pEntity, long pGameTime) {
    ...
    protected void tick(ServerLevel pLevel, CustomNpc pOwner, long pGameTime) {
    ...
    protected boolean canStillUse(ServerLevel pLevel, CustomNpc pEntity, long pGameTime) {
